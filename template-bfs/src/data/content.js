...
export const content = {
  ...
  instructors: [
    {
      id: 1,
      name:    "Sensei Rafael Zain Pedraza Munguia",
      rank:    "Cinta Negra 4° Dan",
      title:   "Fundador & Director Tecnico",
      bio:     "Fundador de BFS Martial Arts. Cinturon Negro 4° Dan con trayectoria en competencia nacional e internacional. Atleta Top Ten Mexico en kickboxing y pointfighting (NASKA). Formador de atletas de alto rendimiento con metodologia orientada a resultados.",
    ...
    },
    {
      ...
      rank:    "Cinta Negra {{X}}° Dan",
      title:   "{{Especialidad}}",
      bio:     "{{Bio del instructor. Experiencia, logros y especialidad.}}",
      photo:   "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80",
      specialties: ["{{Especialidad 1}}", "{{Especialidad 2}}", "{{Especialidad 3}}"],
